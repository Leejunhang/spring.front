...
const Comment = ({pid}) => {
    ...
    const onDelete = async(cid) => {
        if(window.confirm(`${cid}번 댓글을 삭제하시겠습니까?`)){
    ...
    return (
        <div className='mt-5'>
            ...
            {sessionStorage.getItem("uid") ?
                ...
                <Button className='w-100 mb-5'  onClick={onLogin}>댓글작성</Button>
                </div>
            }
            <hr/>
            {list.map(com=>
                    ...
                    <Col>
                        ...
                        {sessionStorage.getItem("uid")===com.writer && 
                            <div className='text-end'>
                                <Button className='btn-sm' variant='primary' onClick={()=>onClickUpdate(com.cid)}>수정</Button>
